...
<div class="col-sm-6 mt-5 mx-3">
	<h3 class="text-center">Assigned Work Detailes</h3>
	<?php 
	if(isset($_REQUEST['view'])){
		...
		<div class="text-center">
			...
			<form class="d-print-none d-inline"><input class="btn btn-danger" type="submit" value="Print" onClick='window.print()' name="">
			</form>

			<form class="d-print-none d-inline" action="work.php">
			<input type="submit" class="btn btn-secondary" value="Close" name="">
			</form>
