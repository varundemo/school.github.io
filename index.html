...
<nav class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
	...
	<div class="collapse navbar-collapse" id="myMenu">
		<ul class="navbar-nav pl-5 custom-nav">
			<li class="nav-item pl-2"><a href="index.php">Home</a></li>
			<li class="nav-item  pl-2" ><a href="#Services">Services</a></li>
			<li class="nav-item pl-2 "><a href="#reg">Registration</a></li>
			<li class="nav-item pl-2"><a href="Requester/RequesterLogin.php">Login</a></li>
			<li class="nav-item pl-2"><a href="#contact">Contact</a></li>
		</ul>
	</div>
</nav>
<!-- end navigation -->
...
<header class="jumbotron back-image" style="background-image:url(image/Banner1.jpeg);">
	<div class="myclass mainHeading">
		...
		<p class="font-italic aim">Customer's Happiness is our Aim</p>
		...
		<div class="row py-3">
			<div class="col-md-6">
             ...
             <span>
				...
				<small>Designed by Someone &copy; 2020</small>
